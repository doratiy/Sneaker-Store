...
EMAIL_TO=почта_для_получения_писем@gmail.com
PORT=5000
```
...
Письма отправляются через API RESENT. Данные из формы обратной связи приходят на почту, указанную в .env. Шаблон письма формируется в коде в переменной email_content.
