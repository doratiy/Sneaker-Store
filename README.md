...
Письма отправляются через API Resend. Данные из формы обратной связи приходят на почту, указанную в json. Шаблон письма формируется в коде в переменной email_content.
